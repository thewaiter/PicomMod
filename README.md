...
```ShellSession
sudo apt update
sudo apt install moksha-module-picom
```
...
>[github.com/thewaiter/PicomMod/issues](https://github.com/thewaiter/PicomMod/issues)
